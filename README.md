...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so fnf can be imported
    │
    ├── fnf                <- Source code for use in this project.
    │   ├── __init__.py    <- Makes fnf a Python module
    │   │
