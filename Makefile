.PHONY: git dvc pipeline all clean data lint requirements sync_data_to_s3 sync_data_from_s3
...
## Make Dataset
data: requirements
	$(PYTHON_INTERPRETER) fnf/data/make_dataset.py
